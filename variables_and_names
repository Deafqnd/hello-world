...
current_date = "September 16, 2025"
player = "Vladamir Guerrero Jr."
...
home_runs_per_game = round(home_runs_per_game, 2)
...
print (f"the current MBL record for most home runs in a season is {home_run_record}. ")
